...
//		engine.getPhysicsUpdateState() = EPhysicsUpdateState::CAPPED;
//	}
//	else if (engine.getGameState() == EGameState::GAME) {
//		engine.setGameState(EGameState::UI);
//		window->setCursorFocus(false);
//		engine.getPhysicsUpdateState() = EPhysicsUpdateState::STOPPED;
//	}
//}
//void on1KeyPressed() {
...
//}
//
//void onMouseLeftClick(float dx, float dy) {
//	if (engine.getGameState() == EGameState::UI) {
//		double mx, my;
//		glfwGetCursorPos(window->getRawWindow(), &mx, &my);
//		if (engine.cursorInUI(menuUI)) return;
//		SceneObject* obj = engine.pickSceneObject(mx, my, camera);
//		if (obj)
//			LOG(SceneObjectKeyRegister::getKeyByObj(obj));
//
//	}
//}
//
...
//
//	AxisConstraint standConstraint = AxisConstraint(SceneObjectKeyRegister::getKeyByObj(stand));
...
//
//	AxisConstraint plateConstraint = AxisConstraint(SceneObjectKeyRegister::getKeyByObj(plate));
...
//
//	AxisConstraint payloadConstraint = AxisConstraint(SceneObjectKeyRegister::getKeyByObj(payload));
...
//
//	AxisConstraint weightConstraint = AxisConstraint(SceneObjectKeyRegister::getKeyByObj(weight));
...
//
//	HingeConstraint hinge(SceneObjectKeyRegister::getKeyByObj(cube1), SceneObjectKeyRegister::getKeyByObj(cube2));
...
//	userInput->setMouseButtonAction(0, onMouseLeftClick);
//}
//
//void end() {
//	LOG("End Called");
